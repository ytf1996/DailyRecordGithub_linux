...
namespace Roim.Common
{
    public static class EnumHelperEx
    {
        ...
        {
            return GetEnumCustomDescription(value);
        }
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        private static string GetEnumCustomDescription(object e)
        {
            //获取枚举的Type类型对象
            Type t = e.GetType();
        ...
        public static List<SelectListItem> GetSelectList(Type enumType)
        {
            ...
            {
                selectList.Add(new SelectListItem() { Text = GetEnumCustomDescription(e), Value = (e).ToString() });
            }
            return selectList;
        }
    }
